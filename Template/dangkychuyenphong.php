           ...
           <form class="col-md-12 m-auto" action="" method="POST">
              <div class="form-row">
                 ...
                 <div class="form-group col-sm-4">
                    ...
                    <input type="text" class="form-control"  value="<?php if(isset($row2['MaPhong'])) echo $row2['MaPhong']; else echo "Bạn chưa đăng ký phòng!"; ?>" disabled>
                    <input hidden class="form-control" name="phongdo" value="<?php if(isset($row2['MaPhong'])) echo $row2['MaPhong']; else echo "Bạn chưa đăng ký phòng!"; ?>" >
                 </div>
              </div><hr>
